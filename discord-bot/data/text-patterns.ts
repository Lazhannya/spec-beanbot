...
export const textPatterns: TextPattern[] = [
  {
    ...
    response: {
      type: "both",
      message:
        "👋 I'm here to help! What can I assist you with? You can also use `/help` to see available commands.",
      reaction: "🤝",
  ...
  },
  {
    ...
    response: {
      type: "both",
      message:
        "📅 I can help you set up reminders! Use the web interface or mention me with your reminder details.",
      reaction: "📅",
