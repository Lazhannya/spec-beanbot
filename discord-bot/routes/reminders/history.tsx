...
function ActivitySummaryCard({ summary }: { summary: UserActivitySummary }) {
  const responseRate = summary.totalRemindersReceived > 0
    ? ((summary.remindersAcknowledged / summary.totalRemindersReceived) * 100)
      .toFixed(1)
    : "0";
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
      ...
      <div class="mt-6 pt-4 border-t border-gray-200">
        <div class="grid grid-cols-2 gap-4 text-sm text-gray-600">
          ...
          <div>
            <span class="font-medium">Most Active Hour:</span>{" "}
...
function FilterControls({
  ...
  onChange: (
    filters: { type: InteractionType | undefined; period: number },
  ) => void;
}) {
      ...
      <div class="min-h-screen bg-gray-50 flex items-center justify-center">
        <div class="text-center">
          ...
          <p class="text-gray-600 mb-6">
            Please log in to view your reminder history.
          </p>
          <a
            href="/auth/discord"
              ...
              : (
                <div class="text-center py-8">
                  ...
                  <p class="text-sm text-gray-500 mt-2">
                    Try adjusting your filters or create some reminders to see
                    activity here.
                  </p>
                </div>
              )}
